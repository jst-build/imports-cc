# System library `nlohmann_json` for the `jst` build system

Target definitions for building against `nlohmann_json` (JSON for Modern
C++) from the local system. This target performs a `pkg-config` lookup and
