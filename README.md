# System library `libarchive` for the `jst` build system

Target definitions for building against `libarchive` from the local
system. This target performs a `pkg-config` lookup and does not compile
anything.
