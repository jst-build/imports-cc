# System library `bzip2` for the `jst` build system

Target definitions for building against `bzip2` from the local system. This
target performs a `pkg-config` lookup and does not compile anything.
