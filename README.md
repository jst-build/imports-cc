# System library `cares` for the `jst` build system

Target definitions for building against `cares` (c-ares, package name
`libcares`) from the local system. This target performs a `pkg-config`
lookup and does not compile anything.
