# System library `ssl` for the `jst` build system

Target definitions for building against `ssl` from the local system. These
targets perform `pkg-config` lookups and do not compile anything.

## How to use this Repository

To import `ssl` to your repository, add the following code to the *imports
