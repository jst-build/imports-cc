# System library `cli11` for the `jst` build system

Target definitions for building against `cli11` (package name `CLI11`) from
the local system. This target performs a `pkg-config` lookup and does not
compile anything.
